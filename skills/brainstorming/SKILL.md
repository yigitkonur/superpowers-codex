...
9. **Transition to implementation** — use $writing-plans skill to create implementation plan
...
1. Dispatch spec-document-reviewer via spawn_agent (see spec-document-reviewer-prompt.md)
